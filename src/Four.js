        ...
        if (this.props.indexChild == 0){
            return (
                <div>
                    ...
                    <Input  className='InputStyle' defaultValue={this.props.item.bb} name = "symbol" onChange={this.handleChangeItem.bind(this)}/>
                    <Input  className='InputStyle' defaultValue={this.props.item.cc} name = "value" onChange={this.handleChangeItem.bind(this)}/>
                    <Input  className='InputStyle' defaultValue={this.props.item.dd} name = "unit" onChange={this.handleChangeItem.bind(this)}/>
