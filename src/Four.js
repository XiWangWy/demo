...
class Four extends Component {
    ...
    render(){
        if (Tools.isEmptyObject(this.props.item)){
                    ...
                    return(
                    <div>
                        <Search className='InputStyle' id ="searchBtn"  onSearch = {this.onSearch.bind(this)}>
            ...
            if (this.props.indexChild == 0){
                return (
                    <div>
                        ...
                        <Input  className='InputStyle' defaultValue={this.props.item.symbol} name = "symbol" onChange={this.handleChangeItem.bind(this)}/>
                        <Input  className='InputStyle' defaultValue={this.props.item.value} name = "value" onChange={this.handleChangeItem.bind(this)}/>
                        <Input  className='InputStyle' defaultValue={this.props.item.unit} name = "unit" onChange={this.handleChangeItem.bind(this)}/>
